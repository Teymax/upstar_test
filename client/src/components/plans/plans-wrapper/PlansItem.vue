    ...
    <div class="plans-item">
        <div class="plans-item-content">
            ...
            <div class="plan-benefits-wrapper">
                ...
                />
                <h3 class="plans-item-content__title">{{ name }}</h3>
                <p class="plans-item-content__description">{{ description }}</p>
                <p class="font__price">
            ...
            >
                Сhoose
                <img v-if="current" :src="check" alt="check" class="plans-item-check" height="60" width="60">
            </v-btn>
        </div>
    </div>
</template>
